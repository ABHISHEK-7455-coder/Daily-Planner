        ...
        <div className="home-container">
            ...
            <main className="home-main">
                ...
                <div className="content-grid">
                    ...
                    <div className="time-card morning-card" onClick={goToTodayPage}>
                    ...
                    <div className="time-card afternoon-card" onClick={goToTodayPage}>
                        <div className="time-card-image">
                    ...
                    <div className="time-card night-card" onClick={goToTodayPage}>
                        <div className="time-card-image">
